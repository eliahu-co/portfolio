...
export const CHANGES: Change[] = [
  { id: 'doors',    type: 'added',    title: 'Doors added',                 description: '2 doors added to Corridor.',                       crop: '300 345 270 130', marker: { x: 430, y: 402 } },
  { id: 'bedroom3', type: 'modified', title: 'Bedroom 3 boundary modified', description: 'Partition shifted — area 138 SF → 149 SF (+8%).',   crop: '300 430 200 220', marker: { x: 351, y: 548 } },
  { id: 'toilet',   type: 'removed',  title: 'Toilet removed',              description: 'Toilet removed from Bath 2.',                      crop: '110 205 180 145', marker: { x: 178, y: 286 } },
]
