        ...
        <tbody>
          {USE_CASES.map((uc, i) => (
            <tr
              ...
              style={i === 0 ? { backgroundImage: 'linear-gradient(90deg, rgba(6,150,215,0.10) 0%, rgba(6,150,215,0.30) 38%, rgba(255,255,255,0.7) 50%, rgba(6,150,215,0.30) 62%, rgba(6,150,215,0.10) 100%)', backgroundSize: '200% 100%' } : undefined}
            >
              <td className={`py-4 pr-4 font-serif text-[20px] ${i === 0 ? 'font-medium text-autodesk-blue' : 'text-black'}`}>
