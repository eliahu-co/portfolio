      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
        <div>
          ...
          <ul className="flex flex-col gap-3">
            {SCOPE_IN.map((s, i) => (
              <li key={i} className="flex gap-2 font-sans text-[16px] leading-relaxed text-charcoal hover:font-bold hover:text-black">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3">
            {SCOPE_OUT.map((s, i) => (
              <li key={i} className="flex gap-2 font-sans text-[16px] leading-relaxed text-charcoal/60 hover:font-bold hover:text-black">
