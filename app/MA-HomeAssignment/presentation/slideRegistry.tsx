...
export const slideRegistry = [
  ...
  { id: 'slide-4', title: 'Hometown', shortTitle: 'Hometown', chapter: 'Three bets', Component: Slide06HometownThesis },
  { id: 'slide-5', title: 'Card Bounty', shortTitle: 'Card Bounty', chapter: 'Three bets', Component: Slide08CardBountyThesis },
  { id: 'slide-6', title: 'Hot Trail', shortTitle: 'Hot Trail', chapter: 'Three bets', Component: Slide10HotTrailThesis },
  { id: 'slide-7', title: 'Assumptions', shortTitle: 'Assumptions', chapter: 'Three bets', Component: Slide12Assumptions },
  { id: 'slide-8', title: 'Comparative scoring', shortTitle: 'Scoring', chapter: 'Decision', Component: Slide13ComparativeScoring },
  { id: 'slide-9', title: 'Expanded player flow', shortTitle: 'Player flow', chapter: 'Player flow', Component: Slide15PlayerFlow },
  { id: 'slide-10', title: 'MVP scope', shortTitle: 'MVP scope', chapter: 'Player flow', Component: Slide16MvpScope },
  { id: 'slide-11', title: 'Interactive prototype', shortTitle: 'Prototype', chapter: 'Player flow', Component: Slide17Prototype },
  { id: 'slide-12', title: 'A/B-test design', shortTitle: 'A/B test', chapter: 'Validation', Component: Slide18ExperimentDesign },
  { id: 'slide-13', title: 'Success metrics and guardrails', shortTitle: 'Metrics', chapter: 'Validation', Component: Slide19Metrics },
