...
export const slideRegistry = [
  ...
  { id: 'slide-4', title: 'A timed counter-Raid where you Spin to catch the thief', shortTitle: 'Feature 1', chapter: 'Three bets', closingMenu: false, Component: SlideFeature1Intro },
  { id: 'slide-5', title: 'Hot Trail', shortTitle: 'Hot Trail', chapter: 'Three bets', Component: Slide10HotTrailThesis },
  { id: 'slide-6', title: 'A LiveOps event where every Chest you buy gets you closer to a Card you choose', shortTitle: 'Feature 2', chapter: 'Three bets', closingMenu: false, Component: SlideFeature2Intro },
