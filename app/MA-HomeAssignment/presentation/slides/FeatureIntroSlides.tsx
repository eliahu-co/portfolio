...
export function SlideFeature1Intro(props: OpeningSlideProps) {
  return (
    <FeatureIntroSlide
      {...props}
      feature={1}
      statement="A timed counter-Raid where you Spin to catch the thief"
...
export function SlideFeature2Intro(props: OpeningSlideProps) {
  return (
    <FeatureIntroSlide
      {...props}
      feature={2}
      statement="A LiveOps event where every Chest you buy gets you closer to a Card you choose"
