...
export default function Slide01Cover(_props: OpeningSlideProps) {
  return (
    <div className="relative h-full w-full overflow-hidden bg-cm-violet-deep">
      ...
      <div className="absolute -bottom-24 -right-20 h-[420px] w-[420px] rounded-full border-[42px] border-cm-gold/35 bg-cm-crimson/20" />
      ...
      <SlideShell align="centered" className="relative z-10 !bg-transparent">
        <div className="max-w-[820px]">
          ...
          <img
            ...
            alt="Coin Master"
            className="mb-8 h-[86px] w-auto object-contain object-left drop-shadow-[0_5px_12px_rgba(42,27,84,0.35)]"
          />
