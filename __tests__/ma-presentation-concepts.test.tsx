...
describe('MA presentation features', () => {
  it.each([
    ...
    expect(monetization).toHaveClass('flex-col', 'items-start')
    expect(riskSection).toHaveClass('flex-col', 'items-start')
    ...
    expect(disclosures).toHaveClass('mt-8', 'flex', 'flex-col', 'gap-8', 'w-[188%]')
    ...
    expect(monetizationButton).toHaveTextContent('Monetization')
    expect(risksButton).toHaveTextContent('Risks')
    expect(monetizationButton).toHaveClass('cursor-pointer', 'flex-col', 'items-start')
    expect(risksButton).toHaveClass('cursor-pointer', 'flex-col', 'items-start')
    expect(monetizationButton.querySelector('[data-feature-disclosure-label="true"]')).toHaveClass('inline-flex', 'items-center')
    expect(risksButton.querySelector('[data-feature-disclosure-label="true"]')).toHaveClass('inline-flex', 'items-center')
    ...
    expect(monetizationButton.querySelector('img')).toHaveClass('h-9', 'w-9')
    ...
    expect(monetizationButton.querySelector('span')).toHaveClass('text-[12px]', 'leading-[18px]', 'font-medium', 'uppercase', 'tracking-[0.14em]')
    ...
    expect(risksButton.querySelector('img')).toHaveClass('h-9', 'w-9')
    ...
    expect(risksButton.querySelector('span')).toHaveClass('text-[12px]', 'leading-[18px]', 'font-medium', 'uppercase', 'tracking-[0.14em]')
